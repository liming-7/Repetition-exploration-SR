...
class BERT4Rec(nn.Module):
    ...
    def __init__(self, config):
        ...
        if config['shared_emb'] == 0:
            self.last_layer_item_embedding = nn.Embedding(self.n_items + 1, self.hidden_size, padding_idx=0)
    ...
    def calculate_loss(self, item_seq, item_seq_len, pos_items, neg_items=None):
        ...
        if self.loss_type == 'BPR':
            ...
            if self.shared_emb == 1:
                ...
                test_item_emb = self.last_layer_item_embedding.weight[:self.n_items]  # [item_num H]
